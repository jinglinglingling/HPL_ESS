...
def DSECEvents(dsec_dir, gt_dir: Path, nr_events_data=1, delta_t_per_data=50, nr_events_window=-1,
    ...
    dataset_provider = DatasetProvider(dsec_dir, gt_dir, mode, event_representation=event_representation,
